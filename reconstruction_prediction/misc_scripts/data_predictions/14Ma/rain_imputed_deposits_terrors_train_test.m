 ...
 nloop=5000;
 nwarmup=2000;
 data=readtable('data/miocene_v2.csv');% main file
 deposit_data=readtable('deposit_input_all_v2.csv');%file from running the deposit predictor code
 precip=readtable('data/miocene_precip_v2.csv');%preciptation data
