...
fig.savefig( directory_plot+"/map_prediction_/"+ predict_filename+".png", pad_inches=0.6)
fig.clf()
...
fig.savefig(directory_plot+"/map_prediction_uncert_/"+ predict_filename+".png", pad_inches=0.6)
fig.clf()
...
ax_prec_unct.set_xlabel('Paleolongitude', labelpad=10)
ax_prec_unct.set_ylabel('Paleolatitude',  labelpad=10)
fig.savefig(directory_plot+"/map_actual_/"+predict_filename+".png", pad_inches=0.6)
fig.clf()
