...
class GPMC:
    ...
    def calc_residual(self, plot3d=False):
        ...
        self.results_file.write('RMSE train/sd(train data): {0} \n'.format(round(rmse_train/np.std(self.y)     ,3)))
        self.results_file.write('RMSE test /sd(test  data): {0} \n'.format(round(rmse_test /np.std(self.y_test),3)))
