...
nwalkers = 20 # Number of walkers, recommended at least 2 * Nparameter + 1 (recommended more)
niter = 1500  # Number of iterations, recommended at least 500
nburn = 2000  # Number of iterations, recommended at least 20% of niter, check sampler chains for convergence.
