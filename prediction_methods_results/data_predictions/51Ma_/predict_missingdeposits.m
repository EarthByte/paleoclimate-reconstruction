 ...
 nloop=5000;
 nwarmup=2000;
 data=readtable('data/predictor_data_land.csv')
...
csvwrite('results/deposit_results',results)
deposit_input=[Xspace deposit_input];

csvwrite('results/deposit_input',deposit_input)

csvwrite('results/mis_class',misclassify_rate)
