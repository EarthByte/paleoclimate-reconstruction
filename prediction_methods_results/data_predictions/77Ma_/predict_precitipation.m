 ...
 Xlin_14Ma_input=readtable('data/Xlin_14Ma_input.csv');
 Xlin_14Ma_input=table2array(Xlin_14Ma_input);
 precip_train=readtable('data/miocene_precip_v1.csv');
 y_index=3;%log prec
...
%  varnames=char(varnames);
 ...
 test_data=readtable('data/predictor_data_land.csv');
...
results=[test_predictor_data(:,test_space_index) -999*ones(nmiss,1) miss_fit_hat low_cred_lim_miss up_cred_lim_miss]

csvwrite('results/prec_results',results)
